...
import type AutostartTourService from "timed/services/autostart-tour";
import type MediaService from "timed/services/media";
...
export default class TourService extends Tour {
  ...
  @service declare autostartTour: AutostartTourService;
  @tracked model;
