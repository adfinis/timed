...
export default class NavTabsAComponent extends Component {
  get class() {
    return "group max-sm:flex max-sm:justify-center sm:flex sm:items-center gap-x-2 py-2 px-4 sm:border-background sm:border sm:bg-background sm:-mb-px sm:border-b-border group";
  }
