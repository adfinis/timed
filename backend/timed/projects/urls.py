...
r.register(r"task-assignees", views.TaskAssigneeViewSet, "task-assignee")
r.register(r"project-assignees", views.ProjectAssigneeViewSet, "project-assignee")
r.register(r"customer-assignees", views.CustomerAssigneeViewSet, "customer-assignee")
