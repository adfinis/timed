...
<template><div {{style_ this.style}} class="flex w-full overflow-hidden pb-12 pl-8 pt-5 sm:pl-10 md:pl-12" ...attributes>
  <div class="relative flex flex-grow items-end justify-around">
    ...
    <WeeklyOverviewBenchmark @showLabel={{true}} @hours={{this.hours}} @expected={{true}} />
    {{yield}}
  </div>
</div></template>}
