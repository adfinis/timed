...
module.exports = {
  ...
  content: [
    "addon/components/*.{html,js,ts,hbs,gjs,gts,css}",
    "app/styles/*.css",
    "addon/styles/*.css",
    "tests/dummy/app/*.{html,js,ts,hbs,gjs,gts,css}",
    "tests/dummy/app/components/*.{html,js,ts,hbs,gjs,gts,css}",
    "tests/dummy/app/templates/*.{html,js,ts,hbs,gjs,gts,css}",
  ],
  darkMode: "class",
  theme: {
    extend: {
